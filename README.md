...
A Chrome extension that collects JavaScript URLs from network requests and allows you to filter by domain and copy them easily. give it a star if you like it :)
...
- `storage`: To save up to 1000 collected URLs locally so you can find them next time you open the browser
